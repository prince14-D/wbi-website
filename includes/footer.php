<footer class="site-footer">
  <div class="container footer-grid">
    <div class="footer-block footer-about">
      ...
      <p class="footer-brief">
        William Bean Institute (WBI) is a faith-based school committed to academic excellence,
        character formation, and leadership development. 
      </p>
      <p class="mb-0"><i class="bi bi-geo-alt-fill me-1" aria-hidden="true"></i> Duport Road, Paynesville City, Liberia</p>
    </div>
  ...
  <div class="container copyright-row">
    <p>&copy; <?php echo date('Y'); ?> William Bean Institute. All rights reserved.</p>
